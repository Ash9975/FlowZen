    ...
    <header className="sticky top-0 z-50">
      ...
      >
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3.5">
          <Link
            to="/"
            className="flex items-center font-display text-lg font-extrabold"
          >
            <div className="flex mr-3 h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-md ring-1 ring-[#DDE6C2]">
              <img
                src="/logo.png"
                alt="FlowZen"
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link
              to="/login"
              className="rounded-full bg-white px-5 py-2.5 text-sm font-bold text-accent-foreground shadow-soft"
            >
              Login
            </Link>
